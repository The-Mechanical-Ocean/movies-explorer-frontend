  ...
  return (
    <section className='about-me' id='about-me'>
      ...
      <div className='about-me__foto'></div>
        ...
        <p className='about-me__description'>Я родился в Ростове-на-Дону, закончил факультет "средства вычислительной техники и компьютерные сети" в РГКРИПТ, и позже 
          факультет "инфромационныt системs и технологиb" университета ДГТУ. У меня есть прекрасная жена и дочь, а так же сын. 
          Я люблю слушать музыку, я бы сказал - обожаю:) и играю на барабаcах с 14 лет, а ещё увлекаюсь кино, книгами и хорошими играми. 
