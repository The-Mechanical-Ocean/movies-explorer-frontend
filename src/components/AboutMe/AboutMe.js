  ...
  return (
    <section className='about-me' id='about-me'>
      ...
      <div className='about-me__foto'></div>
        ...
        <p className='about-me__description'>Я родился в Ростове-на-Дону, закончил факультет технических средств вычислительной техники и компьютерных сетей РГКРИПТ, и позже 
